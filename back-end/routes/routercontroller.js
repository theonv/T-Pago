...
const router = Router()
import {removeitem, toggleitem, additem, createtask, login, cru, gettasks, deleteTask, updatetask, createlist, getlists, deletelist, updatelist, updateemail, sendEmail, toggletask,} from '../functions/funcoes.js'
